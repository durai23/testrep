...
import pandas as pd
import time
#MODIFIED FROM 2DATAPATHS SO AS TO RUN A FOR LOOP OVER ALL PRINT FOLDERS FROM PRINT_LIST.CSV
#FOR FZJ DISK
...
print_list=pd.read_csv(r'C:\Users\synapse\Desktop\12_21_2018_data_paths\fzj_print_list.csv')
for index, row in print_list.iterrows():
	print_paths_and_log_to_csv(next(os.walk(row['disk_path']))[0],row['final_path'])
#	python .\2data_paths.py --in_folder "S:\pywebcap" --out_file "C:\Users\synapse\Desktop\12_21_2018_data_paths\pywebcap_FINAL.txt"
# print "print paths"
