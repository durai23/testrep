...
int main () {
  ...
  //int n = 28672;        // matrix dimension - all matrices being multiplied will be square
  //int n = 32768;        // matrix dimension - all matrices being multiplied will be square - too large?
